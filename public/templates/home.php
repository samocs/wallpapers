...
<body>
    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content">
                ...
                <a href="galeria.php" class="cta">explore →</a>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="carousel">
                <div class="carousel-item active">
                    <img src="../../../php%20projekt/img/1.jpg" alt="Collection 1">
                </div>
                <div class="carousel-item">
                    <img src="../../../php%20projekt/img/2.jpg" alt="Collection 2">
                </div>
                <div class="carousel-item">
                    <img src="../../../php%20projekt/img/3.jpg" alt="Collection 3">
                </div>
            </div>
    ...
    <section class="preview">
        <div class="container">
            <h2>explore more</h2>
            <p><a href="galeria.php" class="btn">browse full gallery</a></p>
        </div>
    </section>
    ...
    <section class="cta-section">
        <div class="container">
            <div class="cta-content">
                ...
                <a href="galeria.php" class="btn">start browsing</a>
            </div>
        </div>
    </section>
